...
@implementation LSEmitterSnowCell
+ (instancetype)snowCellWithCellImg:(NSString *)cellImg andRadious:(CGFloat)radious andVelocity:(CGFloat)velocity andDirection:(EmitterParticleDirection)direction
{
//    NSLog(@"snowCellWithCellImg ");
    NSString * const snowPic = @"snow.png";//雪花图片样式
    
    LSEmitterSnowCell *cell=[[self alloc] init];
